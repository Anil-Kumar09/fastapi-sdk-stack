...
class Player(Base):
    ...
    teams = relationship("Team",secondary = "team_player",back_populates = "players") # Many-many relationship bw Player and Team tables
...
class TeamPlayer(Base):
    ...
    team_id = Column(Integer,ForeignKey("team.team_id"),primay_key = True,index = True)
